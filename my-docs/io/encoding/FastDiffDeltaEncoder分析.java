...
//如果前后两个RowKey不相等，则把剩下的RowKey:currentState.rowLength + KeyValue.ROW_LENGTH_SIZE - commonPrefix移下来
//排除family
//所以这两个要看commonPrefix的取值

currentState.rowLength + KeyValue.ROW_LENGTH_SIZE - commonPrefix个节
(2位         rlength
rlength位   row key 字节数组)
...
//如果(flag & FLAG_SAME_VALUE)==0，则有value
vlength字节   value字节数组
